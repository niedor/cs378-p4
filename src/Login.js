    ...
    return (
        <div>
            ...
            {signup ? 
                <div>
                    ...
                    <div className="input-container">
                        <button className="redirect" onClick={() => setSignUp(false)}>Already have an account?</button>
                    </div>
                    <div className="input-container">
            ...
            :   <div>
                    <h1>Login</h1>
                    <div className="input-container">
                        <button className="redirect" onClick={() => setSignUp(true)}>Don't have an account yet? Let's sign you up!</button>
                    </div>
                    {loginSuccess ? ''
                    :
